...
const Footer = () => {
  return (
    <div className='flex items-center bg-sky-blue md:py-24 py-16'>
        ...
        <div className='grid grid-cols-4 gap-4 w-[100%]'>
          ...
          <div className='font-light text-gray'>
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <Button className="bg-gradient-to-r from-gradient-1 to-gradient-2">Subscribe</Button>
      ...
      <div className=' md:hidden flex max-w-5xl mx-auto w-full flex flex-col items-center'>
        <div className='grid grid-cols-1 gap-4 px-4'>
          <div className=''>
          <h1 className='text-blue text-lg mb-7 font-bold'>Company</h1>
          <div className='font-light text-gray'>
            <a className='block mb-3' href="#">Why choose us</a>
            <a className='block mb-3' href="#">Review</a>
            <a className='block mb-3' href="#">Customers</a>
